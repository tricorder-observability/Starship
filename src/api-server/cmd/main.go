...
var (
	...
	moduleGrafanaUserName     = flag.String("grafana_user_name", "admin", "Grafana username")
	moduleGrafanaUserPassword = flag.String("grafana_user_pass", "tricorder", "Grafana password")
