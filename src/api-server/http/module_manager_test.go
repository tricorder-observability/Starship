...
func AddModule(t *testing.T, wasmUid string, r *gin.Engine) string {
	...
	assert.Equal(t, true, int(pb.DeploymentStatus_CREATED) == moduleResult.Status)
...
func unDeployModule(t *testing.T, modulID string, r *gin.Engine) {
	...
	assert.Equal(t, int(pb.DeploymentStatus_TO_BE_UNDEPLOYED), resultModule.Status)
}
...
func deployModule(t *testing.T, modulID string, r *gin.Engine) {
	...
	assert.Equal(t, int(pb.DeploymentStatus_TO_BE_DEPLOYED), moduleResult.Status)
