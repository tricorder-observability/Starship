...
def go_deps():
    ...
    go_repository(
        name = "com_github_enriquebris_goconcurrentqueue",
        importpath = "github.com/enriquebris/goconcurrentqueue",
        sum = "h1:JYrDa45N3xo3Sr9mjvlRaWiBHvBEJIhAdLXO3VGVghA=",
        version = "v0.7.0",
    )
    ...
    go_repository(
        ...
        # https://github.com/google/gnostic/issues/139#issuecomment-956320112
    ...
    go_repository(
        ...
        # This patch adds BCC & LLVM defined in @com_github_iovisor_bcc below
    ...
    go_repository(
        ...
        sum = "h1:r5O6y84qHX/z/HZV40JBdx2obsHz7/uRj5b+CcYEdeY=",
        version = "v5.0.4",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_second_state_wasmedge_go",
        importpath = "github.com/second-state/WasmEdge-go",
        sum = "h1:4RZhxKvay9uBM9uzE0jrB/26t1ncQG3LbNQOooKjrHA=",
        version = "v0.11.2",
    )
    go_repository(
    ...
    go_repository(
        name = "io_k8s_api",
        # https://github.com/bazelbuild/bazel-gazelle/issues/327#issuecomment-424421241
    ...
    go_repository(
        ...
        replace = "github.com/grpc/grpc-go",
        sum = "h1:DwzK1WoE3vrzt+q2kC4uRkq9d1uVI3WQr1ctyjNBXIE=",
        version = "v1.51.0",
    )
    go_repository(
